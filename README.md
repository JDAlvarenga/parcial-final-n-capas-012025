...
### Estudiante
- **Jaime Daniel Alvarenga Rossell**: [Tu nombre aquí] - 00069216
- Sección: 02
---
...
# Indicaciones de uso
1. Compilar la aplicacion: `.\mvnw clean package -DskipTests`
2. Construir la imagen de docker: `docker build .`
3. Ejecutar el servicio: `docker compose up -d`
4. Agregar usuarios a la base de datos del contenedor. vea el archivo: `../resources/data.sql`
   * puerto: `5434`
   * usuario: `postgres`
   * contraseña: `root`
